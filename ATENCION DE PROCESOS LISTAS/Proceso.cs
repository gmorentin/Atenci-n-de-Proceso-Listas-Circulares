...
namespace ATENCION_DE_PROCESOS_LISTAS
{
    class Proceso
    {
        ...
        {
            _numProceso = numProceso;
            _vidaProceso = vidaProceso;
            _vidaRestante = vidaProceso;
        }

        public override string ToString()
        {
            return "Proceso: " + _numProceso + Environment.NewLine + "Ciclos originales:  " + _vidaProceso + Environment.NewLine + "Ciclos restantes:   " + _vidaRestante + Environment.NewLine;
        }
    }
}
